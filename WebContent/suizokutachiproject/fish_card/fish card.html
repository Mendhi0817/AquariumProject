...
<html lang="ja">
<head>
    <link rel="stylesheet" href="../fish_card/fish card.css">
...
<div>
    <button name="make" onclick="location.href='../fish_card/fish card make.html'">作成</button>
    <button name="list">一覧</button>
</div>
