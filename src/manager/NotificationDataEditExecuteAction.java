...
import tool.Action;
public class NotificationDataEditExecuteAction extends Action {
...
//		int year=todaysDate.getYear();//現在の年を取得
		...
		notification.setNd(NotificationDataDay);
		    ...
		    request.getRequestDispatcher("../staff/notification_data/edit_complete.jsp").forward(request, response);
